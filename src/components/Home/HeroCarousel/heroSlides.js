export const heroSlides = [
  {
    ...
    title: 'Discover Vietnamese Cultural Heritage',
    subTitle: 'A journey through centuries of history, culture and magnificent nature.'
  },
  {
    _id: 2,
    ...
    subTitle: 'Experience the most important historical and cultural heritage sites.'
  },
  {
    _id: 3,
    image: 'https://images.unsplash.com/photo-1741851374411-9528e6d2f33f?q=50&w=1200&auto=format&fit=crop&ixlib=rb-4.0.3',
    title: 'Connect with Vietnam\'s Past',
    subTitle: 'Immerse yourself in the stories that shaped our nation.'
  }
]
