...
function PlannerDialogV3(props) {
  const {open,setOpen,step,setStep,provinces,selectedProvinces,toggleProvince,selectedSites,toggleSelected,setActiveSite,planner,setPlanner,selectPoint,useCenter,makeRoundTrip,loading,actionLoading,sitesLoading,planRoute,pickLocation,startPickingMap,minimizedPlanner,setMinimizedPlanner} = props;
