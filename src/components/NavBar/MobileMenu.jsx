...
const MobileMenu = ({ isOpen, navLinks, userMenuLinks, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[10000] overflow-y-auto bg-gradient-to-b from-museum-black/98 to-museum-charcoal/98 text-museum-ivory backdrop-blur-2xl lg:hidden pt-navbar-mobile animate-fade-in"
      role="dialog"
      aria-modal="true"
